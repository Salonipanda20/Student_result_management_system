...
<head>
    ...
    <title>Database-Management-Systems-(DBMS)- Registered Students</title>
    <style>
        /* Styling as before */
        body {
...
<body>
    ...
    <h1>Database-Management-Systems-(DBMS)- Registered Students</h1>

    <!-- Input form for student details -->
    <div class="form-container">
        <form action="Database-Management-Systems-(DBMS).jsp" method="post">
    ...
    <%
        ...
        if ("add".equalsIgnoreCase(action)) {
            ...
            session.setAttribute("students", students);
            response.sendRedirect("Database-Management-Systems-(DBMS).jsp");
            return;
        ...
        <tbody>
            ...
            %>
                <tr>
                    ...
                    <td>
                        <a href="Database-Management-Systems-(DBMS).jsp?action=update&rollNo=<%= student.get("rollNo") %>" class="action-btn update-btn">Update</a>
                        <a href="Database-Management-Systems-(DBMS).jsp?action=delete&rollNo=<%= student.get("rollNo") %>" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
                    </td>
                </tr>
            <%
                }
