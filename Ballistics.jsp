...
<head>
    ...
    <title>Ballistics- Registered Students</title>
    <style>
        /* Styling as before */
        body {
...
<body>
    ...
    <h1>Ballistics- Registered Students</h1>

    <!-- Input form for student details -->
    <div class="form-container">
        <form action="Ballistics.jsp" method="post">
    ...
    <%
        ...
        if ("add".equalsIgnoreCase(action)) {
            ...
            session.setAttribute("students", students);
            response.sendRedirect("Ballistics.jsp");
            return;
        ...
        <tbody>
            ...
            %>
                <tr>
                    ...
                    <td>
                        <a href="Ballistics.jsp?action=update&rollNo=<%= student.get("rollNo") %>" class="action-btn update-btn">Update</a>
                        <a href="Ballistics.jsp?action=delete&rollNo=<%= student.get("rollNo") %>" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
                    </td>
                </tr>
            <%
                }
