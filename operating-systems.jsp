...
<head>
    ...
    <title>operating-systems- Registered Students</title>
    <style>
        /* Styling as before */
        body {
...
<body>
    ...
    <h1>operating-systems- Registered Students</h1>

    <!-- Input form for student details -->
    <div class="form-container">
        <form action="operating-systems.jsp" method="post">
    ...
    <%
        ...
        if ("add".equalsIgnoreCase(action)) {
            ...
            session.setAttribute("students", students);
            response.sendRedirect("operating-systems.jsp");
            return;
        ...
        <tbody>
            ...
            %>
                <tr>
                    ...
                    <td>
                        <a href="operating-systems.jsp?action=update&rollNo=<%= student.get("rollNo") %>" class="action-btn update-btn">Update</a>
                        <a href="operating-systems.jsp?action=delete&rollNo=<%= student.get("rollNo") %>" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
                    </td>
                </tr>
            <%
                }
