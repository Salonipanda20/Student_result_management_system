...
<head>
    ...
    <title>Electrical-Circuits-and-Networks Registered Students</title>
    <style>
        /* Styling as before */
        body {
...
<body>
    ...
    <h1>Electrical-Circuits-and-Networks- Registered Students</h1>

    <!-- Input form for student details -->
    <div class="form-container">
        <form action="Electrical-Circuits-and-Networks.jsp" method="post">
    ...
    <%
        ...
        if ("add".equalsIgnoreCase(action)) {
            ...
            session.setAttribute("students", students);
            response.sendRedirect("Electrical-Circuits-and-Networks.jsp");
            return;
        ...
        <tbody>
            ...
            %>
                <tr>
                    ...
                    <td>
                        <a href="Electrical-Circuits-and-Networks.jsp?action=update&rollNo=<%= student.get("rollNo") %>" class="action-btn update-btn">Update</a>
                        <a href="Electrical-Circuits-and-Networks.jsp?action=delete&rollNo=<%= student.get("rollNo") %>" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
                    </td>
                </tr>
            <%
                }
