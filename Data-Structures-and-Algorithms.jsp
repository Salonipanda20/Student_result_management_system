...
<head>
    ...
    <title>Data-Structures-and-Algorithms- Registered Students</title>
    <style>
        /* Styling as before */
        body {
...
<body>
    ...
    <h1>Data-Structures-and-Data-Structures-and-Algorithms- Registered Students</h1>

    <!-- Input form for student details -->
    <div class="form-container">
        <form action="Data-Structures-and-Algorithms.jsp" method="post">
    ...
    <%
        ...
        if ("add".equalsIgnoreCase(action)) {
            ...
            session.setAttribute("students", students);
            response.sendRedirect("Data-Structures-and-Algorithms.jsp");
            return;
        ...
        <tbody>
            ...
            %>
                <tr>
                    ...
                    <td>
                        <a href="Data-Structures-and-Algorithms.jsp?action=update&rollNo=<%= student.get("rollNo") %>" class="action-btn update-btn">Update</a>
                        <a href="Data-Structures-and-Algorithms.jsp?action=delete&rollNo=<%= student.get("rollNo") %>" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
                    </td>
                </tr>
            <%
                }
