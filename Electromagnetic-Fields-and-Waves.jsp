...
<head>
    ...
    <title>Electromagnetic-Fields-and-Waves- Registered Students</title>
    <style>
        /* Styling as before */
        body {
...
<body>
    ...
    <h1>Electromagnetic-Fields-and-Waves- Registered Students</h1>

    <!-- Input form for student details -->
    <div class="form-container">
        <form action="Electromagnetic-Fields-and-Waves.jsp" method="post">
    ...
    <%
        ...
        if ("add".equalsIgnoreCase(action)) {
            ...
            session.setAttribute("students", students);
            response.sendRedirect("Electromagnetic-Fields-and-Waves.jsp");
            return;
        ...
        <tbody>
            ...
            %>
                <tr>
                    ...
                    <td>
                        <a href="Electromagnetic-Fields-and-Waves.jsp?action=update&rollNo=<%= student.get("rollNo") %>" class="action-btn update-btn">Update</a>
                        <a href="Electromagnetic-Fields-and-Waves.jsp?action=delete&rollNo=<%= student.get("rollNo") %>" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
                    </td>
                </tr>
            <%
                }
