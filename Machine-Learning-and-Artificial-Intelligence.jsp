...
<head>
    ...
    <title>Machine-Learning-and-Artificial-Intelligence- Registered Students</title>
    <style>
        /* Styling as before */
        body {
...
<body>
    ...
    <h1>Machine-Learning-and-Artificial-Intelligence- Registered Students</h1>

    <!-- Input form for student details -->
    <div class="form-container">
        <form action="Machine-Learning-and-Artificial-Intelligence.jsp" method="post">
    ...
    <%
        ...
        if ("add".equalsIgnoreCase(action)) {
            ...
            session.setAttribute("students", students);
            response.sendRedirect("Machine-Learning-and-Artificial-Intelligence.jsp");
            return;
        ...
        <tbody>
            ...
            %>
                <tr>
                    ...
                    <td>
                        <a href="Machine-Learning-and-Artificial-Intelligence.jsp?action=update&rollNo=<%= student.get("rollNo") %>" class="action-btn update-btn">Update</a>
                        <a href="Machine-Learning-and-Artificial-Intelligence.jsp?action=delete&rollNo=<%= student.get("rollNo") %>" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
                    </td>
                </tr>
            <%
                }
