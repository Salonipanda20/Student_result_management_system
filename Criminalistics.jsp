...
<head>
    ...
    <title>Criminalistics- Registered Students</title>
    <style>
        /* Styling as before */
        body {
...
<body>
    ...
    <h1>Criminalistics- Registered Students</h1>

    <!-- Input form for student details -->
    <div class="form-container">
        <form action="Criminalistics.jsp" method="post">
    ...
    <%
        ...
        if ("add".equalsIgnoreCase(action)) {
            ...
            session.setAttribute("students", students);
            response.sendRedirect("Criminalistics.jsp");
            return;
        ...
        <tbody>
            ...
            %>
                <tr>
                    ...
                    <td>
                        <a href="Criminalistics.jsp?action=update&rollNo=<%= student.get("rollNo") %>" class="action-btn update-btn">Update</a>
                        <a href="Criminalistics.jsp?action=delete&rollNo=<%= student.get("rollNo") %>" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
                    </td>
                </tr>
            <%
                }
